...
class TestCodeless():
  ...
  def test_codeless(self):
    ...
    self.driver.find_element(By.ID, "id_registration-email").send_keys("qwe@qwe.com")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("q1w2e3Q!W@E#")
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("q1w2e3Q!W@E#")
